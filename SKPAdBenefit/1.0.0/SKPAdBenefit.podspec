Pod::Spec.new do |s|
  ...
  s.name = "SKPAdBenefit"
  s.summary = "SKPAdBenefit for ima 3.18  released 2023-03-07 13:00"
  ...
  s.source = {
    :http => "https://github.com/PlanetAdDevelopers/ios-framework/releases/download/v1.0.0/SKPAdBenefit.zip"
  }
